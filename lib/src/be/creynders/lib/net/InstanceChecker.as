package be.creynders.lib.net {
	...
	//--------------------------------------------------------------------------
		...
		static public const PING_RECEIVED : String = 'be.creynders.lib.net::InstanceChecker/pingReceived';
		static public const RELEASE_RECEIVED : String = 'be.creynders.lib.net::InstanceChecker/releaseReceived';
		static public const INSTANCE_FOUND : String = 'be.creynders.lib.net::InstanceChecker/instanceFound';
		static public const IS_LISTENING : String = 'be.creynders.lib.net::InstanceChecker/isListening';
